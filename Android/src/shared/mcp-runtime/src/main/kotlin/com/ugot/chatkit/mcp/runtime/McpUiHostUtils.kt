...
object McpUiHostUtils {
  ...
  fun injectHostBridge(html: String): String {
    val responsiveHostHead =
      """
      <meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover">
      <style id="ugot-mcp-responsive-host">
        html, body {
    ...
    val bridgeScript =
      ...
      (function() {
        ...
        const host = {
          __hostType: 'mcp-apps',
          __connected: true,
          toolName: bridge.getToolName ? bridge.getToolName() : null,
          toolInput: parseJson(bridge.getToolInput ? bridge.getToolInput() : "{}", {}),
          toolOutput: parseJson(bridge.getToolOutput ? bridge.getToolOutput() : "null", null),
          toolResponseMetadata: {},
          widgetState: parseJson(bridge.getWidgetState ? bridge.getWidgetState() : "{}", {}),
        ...
        if (host.toolOutput != null && host.widgetState.lastToolOutput == null) {
          host.widgetState = Object.assign({}, host.widgetState, {
            lastToolOutput: host.toolOutput,
          });
        }
  ...
  internal fun isSupportedWidgetMimeType(mimeType: String?): Boolean {
